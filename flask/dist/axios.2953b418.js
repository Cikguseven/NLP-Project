...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"axios.js":[function(require,module,exports) {
"use strict";
...
form.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
    var formData, error, loader, split_right;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            split_right = document.querySelector('.right');
            split_right.style.visibility = 'hidden';
            _context.next = 10;
            return predict(formData);
...
var predict = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(formData) {
    var response, loader, output, error, split_right, results, offensive_answer, targeted_answer, target_answer;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.post('http://127.0.0.1:5000/predict', formData);
          ...
          case 3:
            ...
            if (output.error) {
              ...
              offensive_answer = document.querySelector('#answer_1');
              offensive_answer.innerHTML = output.offensive;
              targeted_answer = document.querySelector('#answer_2');
              targeted_answer.innerHTML = output.targeted;
              target_answer = document.querySelector('#answer_3');
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","axios.js"], null)
//# sourceMappingURL=/axios.2953b418.js.map